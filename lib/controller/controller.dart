...
import 'package:flutter/material.dart';
import 'package:marsproducts/components/BLUTuthPRINT/blutothPrint.dart';
...
//////////////////////////////////////////////////////
  getSaleBagDetails(String customerId, String os, String type,
    ...
    print("salebagList lenn----$salebagLength");
...
/////////////////////////////////////////////////////////////
  deleteFromSalesBagTable(
    ...
    print("tyyyyyyyyyyyyyyyyyp--${res.runtimeType}");
if (res!=null) {
   bagList.clear();
    for (var item in res) {
      bagList.add(item);
...
//////////////////////////////////////////////////////////////
  printSales(
    ...
    String cont=await setConnect("DC:0D:30:6E:A2:EE");
    print("conted? ====$cont");
    if(cont=="true"){
      
     BluePrint bl=BluePrint();
     bl.printRecee(printSalesData, salesMasterData["payment_mode"], isCancelled, balance!);
    //  Sunmi printer = Sunmi();
